...
<%
	...
	//lectureYear는 int형이기에 Integer형으로 형변환 필요
	...
	if(lectureName == null || professorName == null || lectureYear == 0 || semesterDivide == null || 
		...
		script.println("<script>");
		//뭐가 안들어왔나 확인용
		System.out.println("1 " + lectureName);
		System.out.println("2 " + professorName);
		System.out.println("3 " + lectureYear);
		System.out.println("4 " + semesterDivide);
		System.out.println("5 " + lectureDivide);
		System.out.println("6 " + evaluationTitle);
		System.out.println("7 " + evaluationContent);
		System.out.println("8 " + creditScore);
		System.out.println("9 " + comfortableScore);
		System.out.println("10 " + lectureScore);
		System.out.println("11 " + totalScore);
	...
	if (result == -1) {
		...
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("alert('정상적으로 강의 평가가 등록 되었습니다.');");
